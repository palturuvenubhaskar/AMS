  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <select 
          className="w-[240px] px-4 py-2.5 rounded-xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-md border border-white/50 text-gray-900 dark:text-gray-100 text-sm font-semibold shadow-glass focus:outline-none focus:ring-2 focus:ring-brand-purple/20 transition-all cursor-pointer appearance-none"
          value={classFilter} 
