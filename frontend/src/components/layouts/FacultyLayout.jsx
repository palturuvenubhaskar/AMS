    ...
    <div className="flex min-h-screen bg-[#FDFDFD] font-sans overflow-hidden">
      ...
      <aside className="w-[260px] bg-[#DCD0FF]/70 backdrop-blur-xl flex flex-col fixed top-0 left-0 bottom-0 z-50 border-r border-[#DCD0FF]/50 shadow-[4px_0_24px_rgba(0,0,0,0.03)]">
            ...
            {navItems.map(item => {
              ...
              return (
                ...
                >
                  ...
                  <Icon size={20} strokeWidth={isActive ? 2.5 : 2} className={isActive ? 'text-brand-purple' : 'text-gray-400 group-hover:text-gray-700 transition-colors'} />
        ...
        <div className="p-4 pb-6">
          <div className="bg-white/60 backdrop-blur-md rounded-[24px] p-2 flex flex-col items-center justify-center border border-white/50 shadow-glass group hover:bg-white transition-colors cursor-pointer" onClick={() => navigate('/faculty/settings')}>
            <div className="flex items-center gap-3 w-full p-2">
              ...
              <div className="min-w-0 flex-1">
                <h4 className="text-gray-900 text-sm font-bold truncate">{user?.fullName || 'Faculty User'}</h4>
