    ...
    <div className="space-y-6 animate-[fadeIn_0.5s_ease-out] font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white dark:bg-[#12141d] p-4 md:p-6 rounded-[24px] border border-slate-200 dark:border-[#222430] shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-slate-900 dark:text-slate-100 text-2xl font-black tracking-tight mb-1">Assign Faculty</h1>
            ...
            <form onSubmit={handleMapSubject} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  <select 
                    className="w-full appearance-none bg-slate-50 dark:bg-[#050505] border border-slate-200 dark:border-[#222430] text-slate-900 dark:text-slate-100 text-sm font-semibold rounded-xl pl-4 pr-10 py-3 focus:outline-none focus:ring-4 focus:ring-palette-medium/20 focus:border-palette-medium transition-all"
      ...
      {!selectedClass && (
        <div className="bg-white dark:bg-[#12141d] rounded-[24px] border border-slate-200 dark:border-[#222430] shadow-[0_8px_30px_rgb(0,0,0,0.04)] p-12 text-center">
          <BookOpen size={48} className="mx-auto text-gray-200 mb-4" />
          <h3 className="text-xl font-bold text-slate-900 dark:text-slate-100 mb-2">Select a Class</h3>
