...
export default function LeaveHistory() {
  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease-out] font-sans">
      <h1 className="text-gray-900 text-3xl font-black tracking-tight mb-8">My Leave Requests</h1>
            ...
            <tbody className="divide-y divide-gray-100/50 bg-white/20">
              {leaves.map(l => (
                <tr key={l.id} className="hover:bg-white/40 transition-colors">
                  <td className="px-6 py-4 text-sm font-semibold text-gray-900">{new Date(l.from_date).toLocaleDateString()}</td>
                  <td className="px-6 py-4 text-sm font-semibold text-gray-900">{new Date(l.to_date).toLocaleDateString()}</td>
                  <td className="px-6 py-4 text-sm font-medium text-gray-600">{l.reason}</td>
                  ...
                  <td className="px-6 py-4 text-sm font-black text-gray-900">{l.attendance_pct_snapshot}%</td>
                  <td className="px-6 py-4">
