          ...
          <div key={i} className={`flex-1 px-4 py-3 rounded-2xl text-xs font-bold text-center transition-all ${
            step > i 
              ...
              : step === i + 1 
                ...
                : 'bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-md text-gray-400 border border-white/50 border-b-2 border-b-transparent'
          }`}>
            {i+1}. {label}
          </div>
        ))}
      ...
      {step === 1 && (
        <div className="bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-xl border border-white/50 rounded-3xl shadow-glass p-4 md:p-8 max-w-2xl">
          ...
          <div className="mb-6">
            ...
            <select 
              className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#12141d] border border-slate-200 dark:border-[#222430] text-slate-900 dark:text-slate-100 font-medium focus:outline-none focus:ring-2 focus:ring-brand-purple/20 focus:border-brand-purple/30 transition-all appearance-none cursor-pointer"
        ...
        <div className="bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-xl border border-white/50 rounded-3xl shadow-glass p-4 md:p-8 max-w-2xl">
          ...
          <div className="grid grid-cols-2 gap-5 mb-6">
            <div>
              ...
              <input 
                type="date" 
                className="w-full px-4 py-3 rounded-xl bg-white dark:bg-[#12141d] border border-slate-200 dark:border-[#222430] text-slate-900 dark:text-slate-100 font-medium focus:outline-none focus:ring-2 focus:ring-brand-purple/20 focus:border-brand-purple/30 transition-all"
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-4">
              <label className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 cursor-pointer transition-all ${mode === 'manual' ? 'border-brand-purple bg-brand-purple/5 text-brand-purple' : 'border-slate-200 dark:border-[#222430] bg-white dark:bg-[#12141d] text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:bg-[#050505]'}`}>
              ...
              <label className={`flex-1 flex items-center justify-center gap-2 py-3 px-4 rounded-xl border-2 cursor-pointer transition-all ${mode === 'frs' ? 'border-brand-purple bg-brand-purple/5 text-brand-purple' : 'border-slate-200 dark:border-[#222430] bg-white dark:bg-[#12141d] text-gray-600 dark:text-gray-400 hover:bg-slate-50 dark:bg-[#050505]'}`}>
          ...
          <div className="flex gap-3">
            <button className="flex-1 py-3.5 rounded-xl bg-white dark:bg-[#12141d] border border-slate-200 dark:border-[#222430] text-gray-600 dark:text-gray-400 font-bold hover:bg-slate-50 dark:bg-[#050505] transition-all" onClick={() => setStep(1)}>← Back</button>
            <button 
      ...
      {step === 3 && (
        <div className="bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-xl border border-white/50 rounded-3xl shadow-glass p-4 md:p-8 max-w-4xl">
          ...
          <div className="space-y-3">
            {students.map((s, i) => (
              <div key={s.id} className="flex items-center justify-between bg-white dark:bg-[#12141d] rounded-2xl p-4 border border-slate-200 dark:border-[#222430] shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center gap-4">
                  <span className="w-6 text-gray-400 font-bold text-xs">{i+1}</span>
                  <span className="font-mono text-gray-500 dark:text-gray-400 text-sm bg-slate-50 dark:bg-[#050505] px-2 py-1 rounded">{s.roll_no}</span>
                  <span className="font-bold text-slate-900 dark:text-slate-100">{s.full_name}</span>
                </div>
                <div className="flex bg-slate-50 dark:bg-[#050505] p-1 rounded-xl border border-slate-200 dark:border-[#222430]">
                  <button 
          ...
          <div className="flex gap-3 mt-8 pt-6 border-t border-gray-100">
            <button className="flex-1 py-3.5 rounded-xl bg-white dark:bg-[#12141d] border border-slate-200 dark:border-[#222430] text-gray-600 dark:text-gray-400 font-bold hover:bg-slate-50 dark:bg-[#050505] transition-all max-w-[200px]" onClick={() => setStep(2)}>← Back</button>
            <button 
