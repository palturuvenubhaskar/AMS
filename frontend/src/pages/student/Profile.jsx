...
export default function Profile() {
  ...
  return (
    <div className="animate-[fadeIn_0.5s_ease-out] font-sans">
      <h1 className="text-gray-900 text-3xl font-black tracking-tight mb-8">My Profile</h1>
      <div className="bg-white/60 backdrop-blur-xl border border-white/50 rounded-3xl p-8 shadow-glass max-w-2xl">
        <div className="flex items-center gap-6 mb-8">
          ...
          <div>
            <h2 className="text-gray-900 text-2xl font-black tracking-tight mb-1">{profile.full_name}</h2>
            <p className="text-gray-500 font-medium">Roll No: {profile.roll_no}</p>
          </div>
        </div>
