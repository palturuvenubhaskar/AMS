    ...
    <div className="flex min-h-screen bg-[#FDFDFD] dark:bg-[#0f172a] font-sans overflow-hidden">
      ...
      <aside className="w-[260px] bg-[#DCD0FF]/70 dark:bg-gray-900/70 backdrop-blur-xl flex flex-col fixed top-0 left-0 bottom-0 z-50 border-r border-[#DCD0FF]/50 dark:border-gray-800 shadow-[4px_0_24px_rgba(0,0,0,0.03)]">
        ...
        <div className="p-4 pb-6">
          <div className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-md rounded-[24px] p-2 flex flex-col items-center justify-center border border-white/50 shadow-glass group hover:bg-white dark:bg-gray-800 transition-colors cursor-pointer" onClick={() => navigate('/student/profile')}>
            <div className="flex items-center gap-3 w-full p-2">
              ...
              <div className="min-w-0 flex-1">
                <h4 className="text-gray-900 dark:text-gray-100 text-sm font-bold truncate">{user?.fullName || 'Student User'}</h4>
                <p className="text-gray-500 dark:text-gray-400 text-xs font-medium truncate">{user?.studentInfo?.roll_no || '2026'}</p>
              </div>
            </div>
            <button
        ...
        <header className="h-[90px] px-8 flex items-center justify-between sticky top-0 z-40 bg-surface-base dark:bg-gray-900/40 backdrop-blur-xl">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-3">
              <button className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 shadow-glass flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-brand-purple hover:scale-105 transition-all border border-gray-100 dark:border-gray-700">
                <Clock size={18} strokeWidth={2.5} />
              </button>
              <button onClick={toggleTheme} className="w-10 h-10 rounded-full bg-white dark:bg-gray-800 shadow-glass flex items-center justify-center text-gray-500 dark:text-gray-400 hover:text-brand-purple hover:scale-105 transition-all border border-gray-100">
