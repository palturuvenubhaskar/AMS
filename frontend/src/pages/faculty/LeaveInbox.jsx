...
export default function LeaveInbox() {
  ...
  return (
    <div>
      ...
      {leaves.length === 0 ? (
        <div className="bg-white/60 dark:bg-[#111111]/60 backdrop-blur-xl border border-white/50 rounded-3xl shadow-glass p-16 text-center max-w-2xl mx-auto mt-12">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between bg-white/60 dark:bg-[#111111]/60 p-4 rounded-2xl border border-white/50 shadow-sm gap-4">
            <div className="flex items-center gap-3">
              <input 
                type="checkbox" 
                className="w-5 h-5 rounded border-slate-300 dark:border-[#333] text-brand-purple focus:ring-brand-purple"
            ...
            {selected.size > 0 && (
              <div className="flex items-center gap-3 flex-wrap">
                <input 
                  ...
                  className="px-4 py-2.5 text-sm rounded-xl border border-slate-200 dark:border-[#222] focus:outline-none focus:ring-2 focus:ring-brand-purple/20"
                  value={bulkRemarks}
          ...
          {leaves.map(l => (
            <div key={l.id} className="bg-white/60 dark:bg-[#111111]/60 backdrop-blur-xl border border-white/50 rounded-3xl shadow-glass p-8 transition-all hover:bg-white/80 dark:bg-[#111111]/80 flex gap-4">
              <div className="pt-1">
                <input 
                  type="checkbox" 
                  className="w-5 h-5 rounded border-slate-300 dark:border-[#333] text-brand-purple focus:ring-brand-purple"
              ...
              <div className="flex-1">
                ...
                {l.description && (
                  <div className="mb-6 pl-4 border-l-4 border-slate-200 dark:border-[#222]">
