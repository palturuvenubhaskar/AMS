            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
              <thead>
                <tr className="bg-gray-50/50">
                  ...
                  <th className="px-4 md:px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100">Code</th>
                  ...
                  <th className="px-4 md:px-6 py-4 text-xs font-bold text-gray-400 uppercase tracking-widest border-b border-gray-100">Credits</th>
              ...
              <tbody>
                {subjects.map(s => (
                  <tr key={s.id} className="group hover:bg-indigo-50/30 transition-colors border-b border-gray-50 last:border-0">
                    ...
                    <td className="px-4 md:px-6 py-4 font-black font-mono text-xs text-gray-600 dark:text-gray-400 tracking-wider">{s.code}</td>
                    <td className="px-4 md:px-6 py-4 font-bold text-sm text-slate-900 dark:text-slate-100">{s.name}</td>
                    <td className="px-4 md:px-6 py-4">
                      <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-slate-100 dark:bg-[#12141d] text-gray-700 dark:text-gray-300 font-bold text-xs">
                        {s.credits}
                      </span>
                    </td>
                    <td className="px-4 md:px-6 py-4">
                ...
                {subjects.length === 0 && (
                  <tr><td colSpan="5" className="px-4 md:px-6 py-12 text-center text-gray-400 font-medium">No subjects found.</td></tr>
                )}
              </tbody>
            </table>
          </div>
            ...
            <form onSubmit={save} className="p-4 md:p-6 space-y-4">
              <div>
                ...
                <div className="relative">
                  <select 
                    className="w-full appearance-none bg-slate-50 dark:bg-[#050505] border border-slate-200 dark:border-[#222430] text-slate-900 dark:text-slate-100 text-sm font-semibold rounded-xl pl-4 pr-10 py-3 focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input 
                    type="number" className="w-full bg-slate-50 dark:bg-[#050505] border border-slate-200 dark:border-[#222430] text-slate-900 dark:text-slate-100 text-sm font-semibold rounded-xl px-4 py-3 focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
