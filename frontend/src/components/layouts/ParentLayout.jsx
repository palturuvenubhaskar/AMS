...
export default function ParentLayout() {
  ...
  return (
    <div className="flex min-h-screen bg-slate-50 dark:bg-[#050505] font-sans overflow-hidden">
      ...
      {/* ====== SIDEBAR ====== */}
      <aside className="hidden md:flex w-[260px] bg-white/70 backdrop-blur-xl flex flex-col fixed top-0 left-0 bottom-0 z-50 border-r border-slate-200 dark:border-[#222430] shadow-[4px_0_24px_rgba(0,0,0,0.03)]">
        {/* Brand */}
        ...
        <div className="p-4 pb-6">
          <div className="bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-md rounded-[24px] p-2 flex flex-col items-center justify-center border border-slate-200 dark:border-[#222430] shadow-glass group hover:bg-white dark:bg-[#12141d] transition-colors cursor-pointer" onClick={() => {}}>
