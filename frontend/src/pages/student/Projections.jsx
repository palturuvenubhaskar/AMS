...
export default function Projections() {
  ...
  if (!data) {
    return (
      <div className="p-12 text-center text-gray-500 font-bold bg-white rounded-3xl shadow-glass border border-gray-100">
  ...
  return (
    <div className="space-y-8 animate-[fadeIn_0.5s_ease-out]">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-gray-900 text-3xl font-black tracking-tight mb-1">Attendance Projections</h1>
          <p className="text-gray-500 text-sm font-medium">Mathematical projection for the remainder of the semester</p>
        </div>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white rounded-3xl p-6 shadow-glass border border-gray-100 flex flex-col justify-between">
          <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Conducted Classes</div>
          <div className="text-4xl font-black text-gray-900">{data.totalConducted}</div>
          <div className="text-sm font-medium text-gray-500 mt-2">Classes held so far</div>
        </div>

        <div className="bg-white rounded-3xl p-6 shadow-glass border border-gray-100 flex flex-col justify-between">
          <div className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Remaining Classes</div>
          <div className="text-4xl font-black text-gray-900">{data.remainingClasses}</div>
          <div className="text-sm font-medium text-gray-500 mt-2">Estimated until end of semester</div>
        </div>

        <div className="bg-white rounded-3xl p-6 shadow-glass border border-gray-100 flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="text-sm font-medium text-gray-500 mt-2">If you attend every remaining class</div>
        </div>
        ...
        <div className="bg-white rounded-3xl p-6 shadow-glass border border-gray-100 flex flex-col justify-between relative overflow-hidden group">
          ...
          <div className="text-sm font-medium text-gray-500 mt-2">If you miss every remaining class</div>
        </div>
      </div>

      <div className="bg-white rounded-3xl p-8 shadow-glass border border-gray-100 mt-8">
        <h2 className="text-xl font-black text-gray-900 mb-6">Actionable Insights</h2>
        ...
        <div className="space-y-4">
          <div className="flex items-start gap-4 p-5 rounded-2xl bg-gray-50 border border-gray-100">
            ...
            <div>
              <h3 className="font-bold text-gray-900">Target: 75% Attendance</h3>
