...
export default function Users() {
  ...
  return (
    <div className="space-y-6 animate-[fadeIn_0.5s_ease-out] font-sans pb-12 relative">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-2xl p-8 rounded-[32px] border border-white/60 dark:border-[#222430]/60 shadow-glass">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <div className="relative w-full sm:w-48">
            <select 
              className="w-full appearance-none bg-white dark:bg-[#12141d] border border-transparent shadow-sm text-slate-900 dark:text-slate-100 text-sm font-bold rounded-2xl pl-4 pr-10 py-3 focus:outline-none focus:ring-4 focus:ring-brand-purple/10 focus:border-brand-purple/20 transition-all cursor-pointer"
              value={roleFilter} 
      ...
      {/* Data Table */}
      <div className="bg-white/60 dark:bg-[#12141d]/60 backdrop-blur-2xl rounded-[32px] border border-white/60 dark:border-[#222430]/60 shadow-glass overflow-hidden">
        {loading ? (
          ...
          <div className="bg-white/90 backdrop-blur-2xl rounded-[32px] shadow-glass border border-white w-full max-w-md overflow-hidden" onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={saveUser} className="p-8 space-y-5">
              <div>
                ...
                <input 
                  className="w-full bg-white dark:bg-[#12141d] border border-transparent shadow-sm text-slate-900 dark:text-slate-100 text-sm font-bold rounded-2xl px-4 py-3.5 focus:outline-none focus:ring-4 focus:ring-brand-purple/10 focus:border-brand-purple/20 transition-all placeholder-gray-400"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <div className="relative">
                    <select 
                      className="w-full appearance-none bg-white dark:bg-[#12141d] border border-transparent shadow-sm text-slate-900 dark:text-slate-100 text-sm font-bold rounded-2xl pl-4 pr-10 py-3.5 focus:outline-none focus:ring-4 focus:ring-brand-purple/10 focus:border-brand-purple/20 transition-all cursor-pointer"
