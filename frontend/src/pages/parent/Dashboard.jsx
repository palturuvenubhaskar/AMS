  ...
  return (
    <div className="space-y-6 animate-[fadeIn_0.5s_ease-out]">
      ...
      {loading ? (
        ...
        <div className="bg-white/60 dark:bg-gray-800/60 p-12 text-center rounded-3xl border border-white/50 shadow-glass">
          <p className="text-gray-500 dark:text-gray-400 font-bold">No wards linked to your account.</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {wards.map((ward, idx) => (
            <div key={idx} className="bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-white/50 p-6 rounded-[32px] shadow-glass flex flex-col relative overflow-hidden group">
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100">
              ...
              <div className="flex justify-between text-sm font-medium text-gray-500 dark:text-gray-400 bg-gray-50/50 p-4 rounded-2xl border border-gray-100/50 mt-auto">
